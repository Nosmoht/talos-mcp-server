...
- [ ] **machinery SDK version matches CLAUDE.md**: The `github.com/siderolabs/talos` version in go.mod must be consistent with the compatibility range documented in `CLAUDE.md` (currently v1.9.x – v1.12.x, SDK v1.12.6)
